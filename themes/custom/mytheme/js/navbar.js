// console.log('it works!');
 ...
 (function($){
    ...
    "padding": "45px 0","margin-top": "60px"}); 

                $(".heading ").css({"margin-top":"183px","transition": "all 0.5s ease-in-out"})
               
            }else{
                $("header #block-mytheme-main-menu ").css({"background-color":"#bd4f6c",'position': 'fixed','top': '0','width': '100%','z-index':'9',"background-image": "linear-gradient(326deg, #bd4f6c 0%, #d7816a 74%)",
